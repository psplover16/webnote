import{r,h as g,o as s,c as u,a as e,b as l,t as _,n as v,u as y,d,e as f,f as b,i as S,w,j as k,g as m}from"./index-BBZxrLfZ.js";import{_ as C}from"./_plugin-vue_export-helper-x3n3nnut.js";const q={key:0,type:"I"},$=e("li",null,[l("electron進程 "),e("ul",null,[e("li",null,"主進程，Electron 應用程式的主要進程，負責控制應用程式的生命週期、管理窗口、與底層系統進行通信等。主進程運行的是 Node.js 環境，可以使用 Node.js 的模塊和 API，並且可以創建和管理渲染進程。"),e("li",null,"渲染進程是 Electron 應用程式中的網頁代碼運行的地方。渲染進程運行的是網頁環境，可以通過 Electron 提供的 API 與主進程進行通信。")])],-1),x=e("ul",null,[e("li",null,"在main.js設置把屏幕錄製"),e("li",null,"把錄製到的屏幕，在preload.js轉換成stream，放在video標籤"),e("li",null,"video標籤必須在index.html設立"),e("li",null,"在需要利用該video標籤的組件內，調用index.html的video標籤到指定組件 (擷取桌面影像)"),e("li",null,"把預先寫好再preload的錄製功能，在Vue調用。 錄製五秒影片")],-1),P={__name:"ch1",props:{title:String},setup(c){const t=r(!1);r(!1);const i=r(null);let o=()=>{const n=document.getElementById("video");n.paused?n.play():n.pause(),i.value.appendChild(n)};g(()=>{let n=document.getElementById("video");document.getElementById("videoOriginalPos").appendChild(n)});const p=()=>{window.electronAPI.dealStream()};return(n,a)=>(s(),u("div",null,[e("h2",{onClick:a[0]||(a[0]=h=>t.value=!t.value)},[l(_(c.title)+" ",1),e("div",{class:v(["isShow",t.value?"":"rotate180"])},"^",2)]),t.value?(s(),u("ol",q,[$,e("li",null,[l(" desktopCapturer，屏幕錄製 "),e("div",{ref_key:"videoPos",ref:i},null,512),e("button",{onClick:a[1]||(a[1]=(...h)=>y(o)&&y(o)(...h))},"擷取桌面影像"),e("button",{onClick:p},"錄製五秒影片"),x])])):d("",!0)]))}},j={key:0,type:"I"},I=f(`<li>inon配置 <ul><li class="r">安裝 npm i electron-icon-builder -D</li><li>在package.json設置script <br> &quot;build-icon&quot;:&quot;electron-icon-builder --input=./electron/assets/icon/pic.png --output=./electron/assets/ --flatten&quot; 把來源的圖片轉換成icon檔，存至指定位置 (--flatten表示根目錄) </li><li>設置打包後的桌面圖標及安裝圖標 <pre>&quot;mac&quot;: {
...
`)]),e("li",null,[l("electron應用程式構建配置文件 "),e("pre",null,`"build": {
  ...
  "linux": {
    "target": "AppImage"  // 生成 Linux AppImage 文件
            ...
            `)])])],-1),oe=e("li",null," 要打包時，vscode要用 開發者模式打開 ",-1),se=`<meta http-equiv="Content-Security-Policy" content="script-src 'self'">`,ie={__name:"ch3",props:{title:String},setup(c){const t=r(!1),i=r(!1),o=r(!1);return r(!1),(p,n)=>(s(),u("div",null,[e("h2",{onClick:n[0]||(n[0]=a=>t.value=!t.value)},[l(_(c.title)+" ",1),e("div",{class:v(["isShow",t.value?"":"rotate180"])},"^",2)]),t.value?(s(),u("ol",A,[V,T,e("li",null,[e("span",{onClick:n[1]||(n[1]=a=>i.value=!i.value),class:"b"},"js代碼執行前的階段"),i.value?(s(),u("ul",W,Y)):d("",!0)]),e("li",null,[l(" 根目錄放置electron資料夾，內部放electron入口文件， "),e("table",z,[L,e("tr",null,[X,F,e("td",null,[e("span",{class:"b",onClick:n[2]||(n[2]=a=>o.value=!0)},"main.CJS內容"),o.value?(s(),k(D,{key:0,contentsType:"mainCJS",onClosePage:n[3]||(n[3]=a=>o.value=!1)})):d("",!0)]),G,H,K,Q]),Z])]),e("li",null,[e("ul",null,[e("li",null,[l("在index.html設置 "),e("span",{class:"b"},_(se))]),ee,te,ne])]),le,oe])):d("",!0)]))}},ae={__name:"electronPage",setup(c){return(t,i)=>(s(),u("div",null,[m(P,{title:"模組"}),m(ie,{title:"vite建置"}),m(J,{title:"打包"})]))}};export{ae as default};

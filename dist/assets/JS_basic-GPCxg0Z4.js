import{r as s,o as t,c as o,a as n,b as i,t as d,n as b,d as u,e as m,f as g,g as p}from"./index--8CKUDLY.js";const h={key:0,type:"I"},v=m(`<li> 原始類型 <ul><li>undefined，變數已被宣告，但尚未賦值，或者表示變數訪問的屬性或索引不存在。預設是undefined，完全<span class="r">虛無</span>的意思 </li><li>null，表示空的、無效、未定義的值。表示具體的空值，可以賦值給對象。<span>有架子、沒紙捲筒</span></li><li>Boolean</li><li>String</li><li>Number</li><li> symbol <ul><li>ES6導入</li><li> const bunny = symbol(&quot;可愛的小兔子&quot;); <br> console.log(bunny.description); // 可愛的小兔子 </li><li> 不能直接用遍歷、for迴圈撈取，要使用<span class="r">Object.getOwnPropertySymbols()</span></li><li> 放在物件裡面，當作定義屬性key時，要將symbol的值放在[]當中，不然會被當字串 </li><li>不能用 . 取得屬性值，要用[]</li><li> 範例， <pre>const classMate = { 
 ...
  } 
             ...
             </pre> for...in 表示key <br> for...of 表示對象元素 </li></ul></li></ul></li><li> 物件類型 <ul><li>Object</li><li>Array</li><li>Function</li><li>Date</li><li> Regexp <ul> 範例，身分證字號 <br><code> function isValidTaiwanId(id) { <br>  const taiwanIdRegex = /^[A-Z][12]\\d{8}$/; <br>  return taiwanIdRegex.test(id); <br> } </code><br> ^，表示匹配輸入的開始位置。 <br> [A-Z]，表示批妹一個大寫字母。 <br> [12]，表示匹配字符1或2 <br> \\d{8}，表示匹配後面8個數字 <br> $，表示匹配輸入的結束位置 </ul></li></ul></li>`,2),f=[v],y={__name:"ch1",props:{title:String},setup(r){const e=s(!1);return(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(r.title)+" ",1),n("div",{class:b(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",h,f)):u("",!0)]))}},$={key:0,type:"I"},S=n("li",null,[n("span",null,"var，宣告的變數存在變數提升(code執行過程，會被提升至作用域的頂部)，作用範圍為全域，函式範圍作用域，僅限該函式"),n("pre",null,`const b = function () {
  for (var i = 0; i < 5; i++) {
    setTimeout(() => {
      console.log(i)
    }, 0);
        ...
        `)],-1),w=n("li",null,[n("span",null,[i(" let，存在變數提升，但是在初始化之前訪問，會出現暫時性死區。宣告的變數可重新賦值。塊級作用域，僅限該塊級 "),n("pre",null,`const b = function () {
  for (let i = 0; i < 5; i++) {
    setTimeout(() => {
      console.log(i)
    }, 0);
        ...
        `),n("span",null," 每次回圈，i都是一個全新的變量 ")])],-1),j=n("li",null,[n("span",null," const，存在變數提升，宣告的變數為常數")],-1),k=[S,w,j],x={__name:"ch2",props:{title:String},setup(r){const e=s(!1);return g(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(r.title)+" ",1),n("div",{class:b(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",$,k)):u("",!0)]))}},A={key:0,type:"I"},O=m('<li> JS中實現繼承和屬性查找的一種機制，在JS中，每個對象都有一個指向其原型的鏈接。 </li><li> 當我們訪問的一個對象的屬性或方法，如果對象沒有屬性或方法，JS引擎會沿著原型練往上查找，直到找到相應屬性或原型練的頂端<span class="r">Object.prototype</span>。 </li><li> 範例，<br><code> function Animal(name) { <br>   this.name = name; <br>  } <br> Animal.prototype.sayHello = function(){ <br>  console.log(`Hello, I&#39;m ${this.name}`); <br> } <br> let dog = new Animal(&quot;Dog&quot;); <br> dog.sayHello(); </code></li>',3),I=[O],N={__name:"ch3",props:{title:String},setup(r){const e=s(!1);return(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(r.title)+" ",1),n("div",{class:b(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",A,I)):u("",!0)]))}},C={key:0,type:"I"},P=m(`<li><ul><li><span class="r">不會建立自己的 this</span> ，而是 <span class="r">繼承</span> 自其定義時所在的詞法作用域 </li><li>this的值由函數定義時所在的上下文決定，而不是呼叫時的上下文。</li></ul><pre> const obj = { 
  name: &#39;John&#39;, 
  greet: function() { 
   setTimeout(function() { 
...
Promise.all([asyncOperation1, asyncOperation2(), asyncOperation3()])
    ...
    .catch((error) =&gt; {
        ...
        </pre></li>`,6),z=n("pre",null,`setTimeout(() => {
    console.log(1)
}, 0);
console.log(2)
...
console.log(JSON.parse(JSON.stringify(family)));
            `)])])],-1),se=[re],ie={__name:"ch10",props:{title:String},setup(r){const e=s(!1);return s(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(r.title)+" ",1),n("div",{class:b(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",oe,se)):u("",!0)]))}},ae={key:0,type:"I"},ce=m(`<li> 字串切割 <br><code> const str = &#39;apple,banana,orange&#39;; <br> // 使用,做切割 <br> const fruits = str.split(&#39;,&#39;); <br><span class="r">const characters = str.split(&#39;&#39;);</span><br> console.log(fruits); // 輸出: [&#39;apple&#39;, &#39;banana&#39;, &#39;orange&#39;] <br> console.log(characters); // 輸出: [&#39;a&#39;,&#39;p&#39;,&#39;p&#39;,&#39;l&#39;.............] </code></li><li>str.trim()，刪除字符的頭尾空格</li><li>obj(物件).constructor， 查看obj的構建函數(創建對象的函數，構建函數的prototype會自動關聯到該構建函數創建的所有對象實例的原型練上)</li><li>Object.getPrototypeOf(obj(物件)); 返回obj的原型鍊()</li><li>閉包 <pre>  var createCounter = function (n) {
    var z = n - 1;
  ...
  console.log(genA.next().value); // undefined
        </pre></li><li><ul><li>string.toUpperCase(); 字串轉大寫</li><li>string.toLowerCase(); 字串轉小寫</li></ul></li><li>Math.abs(numbers) 回傳一個絕對值</li><li>Math.round(numbers) 回傳一個對小數點，四捨五入的數字</li><li>Math.ceil(numbers) 回傳一個無條件進位至整數</li><li>Math.floor(numbers) 回傳一個無條件捨去至整數</li><li></li><li></li><li></li><li></li>`,15),ue=[ce],pe={__name:"ch11",props:{title:String},setup(r){const e=s(!1);return s(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(r.title)+" ",1),n("div",{class:b(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",ae,ue)):u("",!0)]))}},de={key:0,type:"I"},be=n("li",null,[i("氣泡演算法，不斷重複比較相鄰兩值，來做排序 "),n("pre",null,`  for (let i = 0; i < a.length - 1; i++) {
    for (let j = 0; j < a.length-1-i; j++) {
      if (a[j] < a[j + 1]) {
        ...
        `)],-1),me=n("li",null,[i("選擇排序法，將陣列分成排序和未排序，在未排序的部分持續找最大或最小，將之交換到已排序的部分 "),n("pre",null,`  for (let i = 0; i < a.length - 1; i++) {
    let maxIndex = i;
    ...
    [a[i], a[maxIndex]] = [a[maxIndex], a[i]];
        ...
        `)],-1),ge=n("li",null,"插入排序法，將陣列分成未排序與排序的部分，將元素一個個由未排列的部分拿到已排列的部分並在已排列的部分排序，直到未排列的陣列為空。",-1),_e={__name:"ch12",props:{title:String},setup(r){const e=s(!1);return s(!1),g(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(r.title)+" ",1),n("div",{class:b(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",de,[i(" const a = [0,1,2,3,4,5,6]，由大排到小 "),be,me,ge])):u("",!0)]))}},ve={__name:"JS_basic",setup(r){return(e,a)=>(t(),o("div",null,[p(y,{title:"數據類型"}),p(x,{title:"變量"}),p(N,{title:"原型链(原型方法)"}),p(J,{title:"箭頭函數(ES6)"}),p(q,{title:"解構賦值(ES6)"}),p(W,{title:"Array/Object"}),p(X,{title:"break/continue/return"}),p(F,{title:"非同步(ES6)-promise"}),p(te,{title:"非同步(ES6)-async"}),p(ie,{title:"深層複製"}),p(pe,{title:"常見函數"}),p(_e,{title:"常見演算法"})]))}};export{ve as default};

  ...
  for (let i = 0; i < 5; i++) {
    setTimeout(() => {
      console.log(i)
        ...
        `),n("span",null," 每次回圈，i都是一個全新的變量 ")])],-1),j=n("li",null,[n("span",null," const，存在變數提升，宣告的變數為常數")],-1),k=[S,w,j],A={__name:"ch2",props:{title:String},setup(s){const e=i(!1);return b(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",$,k)):u("",!0)]))}},x={key:0,type:"I"},O=m('<li> JS中實現繼承和屬性查找的一種機制，在JS中，每個對象都有一個指向其原型的鏈接。 </li><li> 當我們訪問的一個對象的屬性或方法，如果對象沒有屬性或方法，JS引擎會沿著原型練往上查找，直到找到相應屬性或原型練的頂端<span class="r">Object.prototype</span>。 </li><li> 範例，<br><code> function Animal(name) { <br>   this.name = name; <br>  } <br> Animal.prototype.sayHello = function(){ <br>  console.log(`Hello, I&#39;m ${this.name}`); <br> } <br> let dog = new Animal(&quot;Dog&quot;); <br> dog.sayHello(); </code></li>',3),I=[O],C={__name:"ch3",props:{title:String},setup(s){const e=i(!1);return(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",x,I)):u("",!0)]))}},J={key:0,type:"I"},N=m(`<li><ul><li><span class="r">不會建立自己的 this</span> ，而是 <span class="r">繼承</span> 自其定義時所在的詞法作用域 </li><li>this的值由函數定義時所在的上下文決定，而不是呼叫時的上下文。</li></ul><pre> const obj = { 
  name: &#39;John&#39;, 
  greet: function() { 
   setTimeout(function() { 
...
Promise.all([asyncOperation1, asyncOperation2(), asyncOperation3()])
    ...
    .catch((error) =&gt; {
        ...
        </pre></li>`,6),V=n("pre",null,`setTimeout(() => {
    console.log(1)
}, 0);
console.log(2)
...
console.log(JSON.parse(JSON.stringify(family)));
            `)])])],-1),ae=[se,re,ie],ce={__name:"ch10",props:{title:String},setup(s){const e=i(!1);return i(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",oe,ae)):u("",!0)]))}},ue={key:0,type:"I"},pe=m(`<li> 字串切割 <br><code> const str = &#39;apple,banana,orange&#39;; <br> // 使用,做切割 <br> const fruits = str.split(&#39;,&#39;); <br><span class="r">const characters = str.split(&#39;&#39;);</span><br> console.log(fruits); // 輸出: [&#39;apple&#39;, &#39;banana&#39;, &#39;orange&#39;] <br> console.log(characters); // 輸出: [&#39;a&#39;,&#39;p&#39;,&#39;p&#39;,&#39;l&#39;.............] </code></li><li>str.trim()，刪除字符的頭尾空格</li><li>obj(物件).constructor， 查看obj的構建函數(創建對象的函數，構建函數的prototype會自動關聯到該構建函數創建的所有對象實例的原型練上)</li><li>Object.getPrototypeOf(obj(物件)); 返回obj的原型鍊()</li><li>閉包 <pre>  var createCounter = function (n) {
    var z = n - 1;
  ...
  console.log(genA.next().value); // undefined
        </pre></li><li><ul><li>string.toUpperCase(); 字串轉大寫</li><li>string.toLowerCase(); 字串轉小寫</li></ul></li><li>Math.abs(numbers) 回傳一個絕對值</li><li>Math.round(numbers) 回傳一個對小數點，四捨五入的數字</li><li>Math.ceil(numbers) 回傳一個無條件進位至整數</li><li>Math.floor(numbers) 回傳一個無條件捨去至整數</li><li>eval(&quot;&quot;) 該函數為會執行參數內全部的東西</li><li></li><li></li><li></li>`,15),de=[pe],ge={__name:"ch11",props:{title:String},setup(s){const e=i(!1);return i(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",ue,de)):u("",!0)]))}},me={key:0,type:"I"},be=n("li",null,[r("氣泡演算法，不斷重複比較相鄰兩值，來做排序 "),n("pre",null,`  for (let i = 0; i < a.length - 1; i++) {
    for (let j = 0; j < a.length-1-i; j++) {
      if (a[j] < a[j + 1]) {
        ...
        `)],-1),he=n("li",null,[r("選擇排序法，將陣列分成排序和未排序，在未排序的部分持續找最大或最小，將之交換到已排序的部分 "),n("pre",null,`  for (let i = 0; i < a.length - 1; i++) {
    let maxIndex = i;
    ...
    [a[i], a[maxIndex]] = [a[maxIndex], a[i]];
        ...
        `)],-1),_e=n("li",null,"插入排序法，將陣列分成未排序與排序的部分，將元素一個個由未排列的部分拿到已排列的部分並在已排列的部分排序，直到未排列的陣列為空。",-1),ye={__name:"ch12",props:{title:String},setup(s){const e=i(!1);return i(!1),b(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",me,[r(" const a = [0,1,2,3,4,5,6]，由大排到小 "),be,he,_e])):u("",!0)]))}},ve={key:0,type:"I"},fe=n("li",null,[r("class "),n("pre",null,`class Myclass {
...
Myclass.staticSayHello(); // Myclass  12345
        `)],-1),$e=n("li",null,[r("extend 繼承，子類繼承父層的屬性和方法，也可以添加自己的屬性或方法 "),n("pre",null,`class MyclassChild extends Myclass {
    speak() {
...
</pre></li></ul> 如果函数使用 call()、apply() 或 bind() 方法进行调用，this 指向作为参数传递的对象。???????????????????????? </li><li>構造函數，this會通過new 創建新對象</li><li>箭頭函數，沒有自己的this，會在創建時，捕獲其上下文作用域的this，當成自己的this</li></ul></li>`,2),Ae={__name:"ch14",props:{title:String},setup(s){const e=i(!1);return i(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",je,[r(" 每個函數都有this，表示函數的執行上下文。函數的執行上下文是指函數被調用時所處的環境，該執行上下文包含了函數被調用時所需要的訊息。 "),ke])):u("",!0)]))}},Oe={__name:"JS_basic",setup(s){return(e,a)=>(t(),o("div",null,[p(f,{title:"數據類型"}),p(A,{title:"變量"}),p(C,{title:"原型链(原型方法)"}),p(we,{title:"類"}),p(Ae,{title:"this指向???"}),p(q,{title:"箭頭函數(ES6)"}),p(T,{title:"解構賦值(ES6)"}),p(U,{title:"Array/Object"}),p(X,{title:"break/continue/return"}),p(z,{title:"非同步(ES6)-promise"}),p(te,{title:"非同步(ES6)-async"}),p(ce,{title:"Call By Value, Call By Reference 參數引用,深層複製"}),p(ge,{title:"常見函數"}),p(ye,{title:"常見演算法"})]))}};export{Oe as default};

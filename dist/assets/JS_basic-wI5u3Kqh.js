  ...
  for (let i = 0; i < 5; i++) {
    setTimeout(() => {
      console.log(i)
        ...
        `),n("span",null," 每次回圈，i都是一個全新的變量 ")])],-1),k=n("li",null,[n("span",null," const，存在變數提升，宣告的變數為常數")],-1),j=[S,w,k],A={__name:"ch2",props:{title:String},setup(s){const e=r(!1);return b(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",$,j)):u("",!0)]))}},x={key:0,type:"I"},O=m('<li> JS中實現繼承和屬性查找的一種機制，在JS中，每個對象都有一個指向其原型的鏈接。 </li><li> 當我們訪問的一個對象的屬性或方法，如果對象沒有屬性或方法，JS引擎會沿著原型練往上查找，直到找到相應屬性或原型練的頂端<span class="r">Object.prototype</span>。 </li><li> 範例，<br><code> function Animal(name) { <br>   this.name = name; <br>  } <br> Animal.prototype.sayHello = function(){ <br>  console.log(`Hello, I&#39;m ${this.name}`); <br> } <br> let dog = new Animal(&quot;Dog&quot;); <br> dog.sayHello(); </code></li>',3),I=[O],C={__name:"ch3",props:{title:String},setup(s){const e=r(!1);return(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",x,I)):u("",!0)]))}},N={key:0,type:"I"},J=m(`<li><ul><li><span class="r">不會建立自己的 this</span> ，而是 <span class="r">繼承</span> 自其定義時所在的詞法作用域 </li><li>this的值由函數定義時所在的上下文決定，而不是呼叫時的上下文。</li></ul><pre> const obj = { 
  name: &#39;John&#39;, 
  greet: function() { 
   setTimeout(function() { 
...
console.log(JSON.parse(JSON.stringify(family)));
            `)])])],-1),ie=[se],re={__name:"ch10",props:{title:String},setup(s){const e=r(!1);return r(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",oe,ie)):u("",!0)]))}},ae={key:0,type:"I"},ce=m(`<li> 字串切割 <br><code> const str = &#39;apple,banana,orange&#39;; <br> // 使用,做切割 <br> const fruits = str.split(&#39;,&#39;); <br><span class="r">const characters = str.split(&#39;&#39;);</span><br> console.log(fruits); // 輸出: [&#39;apple&#39;, &#39;banana&#39;, &#39;orange&#39;] <br> console.log(characters); // 輸出: [&#39;a&#39;,&#39;p&#39;,&#39;p&#39;,&#39;l&#39;.............] </code></li><li>str.trim()，刪除字符的頭尾空格</li><li>obj(物件).constructor， 查看obj的構建函數(創建對象的函數，構建函數的prototype會自動關聯到該構建函數創建的所有對象實例的原型練上)</li><li>Object.getPrototypeOf(obj(物件)); 返回obj的原型鍊()</li><li>閉包 <pre>  var createCounter = function (n) {
    var z = n - 1;
  ...
  console.log(genA.next().value); // undefined
    ...
    [a[i], a[maxIndex]] = [a[maxIndex], a[i]];
        ...
        `)],-1),be=n("li",null,"插入排序法，將陣列分成未排序與排序的部分，將元素一個個由未排列的部分拿到已排列的部分並在已排列的部分排序，直到未排列的陣列為空。",-1),he={__name:"ch12",props:{title:String},setup(s){const e=r(!1);return r(!1),b(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[i(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",de,[i(" const a = [0,1,2,3,4,5,6]，由大排到小 "),ge,me,be])):u("",!0)]))}},_e={key:0,type:"I"},ye=n("li",null,[i("class "),n("pre",null,`class Myclass {

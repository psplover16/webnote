...
</pre></li></ul> 如果函数使用 call()、apply() 或 bind() 方法进行调用，this 指向作为参数传递的对象。???????????????????????? </li><li>構造函數，this會通過new 創建新對象</li><li>箭頭函數，沒有自己的this，會在創建時，捕獲其上下文作用域的this，當成自己的this</li></ul></li>`,2),je={__name:"ch14",props:{title:String},setup(s){const e=i(!1);return i(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",Se,[r(" 每個函數都有this，表示函數的執行上下文。函數的執行上下文是指函數被調用時所處的環境，該執行上下文包含了函數被調用時所需要的訊息。 "),we])):u("",!0)]))}},Ae={__name:"JS_basic",setup(s){return(e,a)=>(t(),o("div",null,[p(f,{title:"數據類型"}),p(j,{title:"變量"}),p(O,{title:"原型链(原型方法)"}),p($e,{title:"類"}),p(je,{title:"this指向???"}),p(N,{title:"箭頭函數(ES6)"}),p(H,{title:"解構賦值(ES6)"}),p(G,{title:"Array/Object"}),p(K,{title:"break/continue/return"}),p(V,{title:"非同步(ES6)-promise"}),p(ne,{title:"非同步(ES6)-async"}),p(ie,{title:"Call By Value, Call By Reference 參數引用,深層複製"}),p(pe,{title:"常見函數"}),p(he,{title:"常見演算法"})]))}};export{Ae as default};

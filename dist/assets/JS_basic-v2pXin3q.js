...
const c = 1;
        </pre></li>`,4),S=[$],j={__name:"ch2",props:{title:String},setup(s){const e=i(!1);return b(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",w,S)):u("",!0)]))}},k={key:0,type:"I"},A=m('<li> JS中實現繼承和屬性查找的一種機制，在JS中，每個對象都有一個指向其原型的鏈接。 </li><li> 當我們訪問的一個對象的屬性或方法，如果對象沒有屬性或方法，JS引擎會沿著原型練往上查找，直到找到相應屬性或原型練的頂端<span class="r">Object.prototype</span>。 </li><li> 範例，<br><code> function Animal(name) { <br>   this.name = name; <br>  } <br> Animal.prototype.sayHello = function(){ <br>  console.log(`Hello, I&#39;m ${this.name}`); <br> } <br> let dog = new Animal(&quot;Dog&quot;); <br> dog.sayHello(); </code></li>',3),x=[A],O={__name:"ch3",props:{title:String},setup(s){const e=i(!1);return(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",k,x)):u("",!0)]))}},N={key:0,type:"I"},C=m(`<li><ul><li><span class="r">不會建立自己的 this</span> ，而是 <span class="r">繼承</span> 自其<span class="r">定義時(創建時)</span>所在的詞法作用域 </li><li>this的值由函數定義時所在的上下文決定，而不是呼叫時的上下文。</li></ul><pre>  const obj = { 
  name: &#39;John&#39;, 
  greet: function() { 
   setTimeout(function() { 
...
console.log(JSON.parse(JSON.stringify(family)));
            `)])])],-1),re=[te,oe,se],ie={__name:"ch10",props:{title:String},setup(s){const e=i(!1);return i(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",le,re)):u("",!0)]))}},ae={key:0,type:"I"},ce=m(`<li> 字串切割 <br><code> const str = &#39;apple,banana,orange&#39;; <br> // 使用,做切割 <br> const fruits = str.split(&#39;,&#39;); <br><span class="r">const characters = str.split(&#39;&#39;);</span><br> console.log(fruits); // 輸出: [&#39;apple&#39;, &#39;banana&#39;, &#39;orange&#39;] <br> console.log(characters); // 輸出: [&#39;a&#39;,&#39;p&#39;,&#39;p&#39;,&#39;l&#39;.............] </code></li><li>str.trim()，刪除字符的頭尾空格</li><li>obj(物件).constructor， 查看obj的構建函數(創建對象的函數，構建函數的prototype會自動關聯到該構建函數創建的所有對象實例的原型練上)</li><li>Object.getPrototypeOf(obj(物件)); 返回obj的原型鍊()</li><li>閉包 <pre>  var createCounter = function (n) {
    var z = n - 1;
  ...
  console.log(genA.next().value); // undefined
    ...
    [a[i], a[maxIndex]] = [a[maxIndex], a[i]];
        ...
        `)],-1),be=n("li",null,"插入排序法，將陣列分成未排序與排序的部分，將元素一個個由未排列的部分拿到已排列的部分並在已排列的部分排序，直到未排列的陣列為空。",-1),he=n("li",null,[r("費氏數列，0, 1, 1, 2, 3, 5, 8, 13, 21... "),n("pre",null,`function feisi(num) {
  if (num <= 1) {
    return num;
  }
  // 遞迴
  ...
  return oldNum + newNum;
        ...
        `)],-1),_e={__name:"ch12",props:{title:String},setup(s){const e=i(!1);return i(!1),b(()=>{}),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",de,[r(" const a = [0,1,2,3,4,5,6]，由大排到小 "),ge,me,be,he])):u("",!0)]))}},ye={key:0,type:"I"},fe=n("li",null,[r("class "),n("pre",null,`class Myclass {
...
</pre></li></ul> 如果函数使用 call()、apply() 或 bind() 方法进行调用，this 指向作为参数传递的对象。???????????????????????? </li><li>構造函數，this會通過new 創建新對象</li><li>箭頭函數，沒有自己的this，會在創建時，捕獲其上下文作用域的this，當成自己的this</li></ul></li>`,2),ke={__name:"ch14",props:{title:String},setup(s){const e=i(!1);return i(!1),(a,l)=>(t(),o("div",null,[n("h2",{onClick:l[0]||(l[0]=c=>e.value=!e.value)},[r(d(s.title)+" ",1),n("div",{class:g(["isShow",e.value?"":"rotate180"])},"^",2)]),e.value?(t(),o("ol",Se,[r(" 每個函數都有this，表示函數的執行上下文。函數的執行上下文是指函數被調用時所處的環境，該執行上下文包含了函數被調用時所需要的訊息。 "),je])):u("",!0)]))}},xe={__name:"JS_basic",setup(s){return(e,a)=>(t(),o("div",null,[p(v,{title:"數據類型"}),p(j,{title:"變量"}),p(O,{title:"原型链(原型方法)"}),p($e,{title:"類"}),p(ke,{title:"this指向???"}),p(J,{title:"箭頭函數(ES6)"}),p(T,{title:"解構賦值(ES6)"}),p(G,{title:"Array/Object"}),p(K,{title:"break/continue/return"}),p(V,{title:"非同步(ES6)-promise"}),p(ne,{title:"非同步(ES6)-async"}),p(ie,{title:"Call By Value, Call By Reference 參數引用,深層複製"}),p(pe,{title:"常見函數"}),p(_e,{title:"常見演算法"})]))}};export{xe as default};
